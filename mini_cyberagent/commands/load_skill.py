...
examples:
    load_skill --name web_sqli
    load_skill --name pwn_heap
notes:
    - This command prints the content of SKILL.md to stdout.
    - It verifies if the skill exists in the index before loading.
    - If the skill has a 'tools' directory, its absolute path will be printed for PATH configuration.
 """
